...
$urltopost = str_replace('test.php','opencart.php',$urltopost);
...
if (isset($_POST["btncheck"]) && ($_POST["btncheck"]=="Test" || $_POST["btncheck"]=="Mail To Webgility")) {
	if (trim($_POST["uname"])!="" && trim($_POST["pwd"])!="") {
		...
		if(isset($_POST['sendmail']) && $_POST['sendmail']=='Y') {
			$subject="Webgility test Information(Opencart)";
			$mailto = "support@webgility.com";
			$mailfrom = "bugs@webgility.com";
			$headers = "From:".$mailfrom."\r\nContent-Type: text/html; charset=iso-8859-1";
			$body = '<html>
					<head><title>Webgility test Report</title></head>
					<body>	
						<table width=644 border=0 cellspacing=2 cellpadding=0 align=center>
							...
							<tr> 
								<td  height=30 >Webgility test URL:</td>
								<td height=30 ><b> '. $_SERVER['HTTP_REFERER'] .'</b></td>
							</tr>
							<tr bgcolor=#E2E6E9> 
								<td height=25 colspan=2 align=center bgcolor=#E2E6E9 class=Text8PTGreyColor> 
									<div align=center><p>copyright 2007-2013 &copy; webgility Inc. all rights reserved.</p></div>
								</td>
							</tr>
...
<body style="font-size:13px;">
		<div id="wrap">Webgility Store Module (v<?php echo $storeMduleVersion; ?>) - Test Page</div>
				...
				<tr>
				 ...
				 <td width="5%" align="center"> <strong><img src="http://www.webgility.com/images/right_16.png" border="0"  /></strong></td>         
				  <td align="left">
					  ...
					  <tr id="6" style="display:none"><td width="100px;">Webgility excl list</td><td width="5%">:</td><td width="65%"><input type="text" name="ecc_excl_list" id="ecc_excl_list" value="<?php echo $_POST['ecc_excl_list']; ?>" /></td></tr>
	...
	<div id="footer">
		<p>copyright 2007-2013 &copy; webgility Inc. all rights reserved.</p>
	</div>
