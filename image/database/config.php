<?php
// HTTP
define('HTTP_SERVER', 'http://104.236.36.204/admin/');
define('HTTP_CATALOG', 'http://104.236.36.204/');

// HTTPS
define('HTTPS_SERVER', 'http://104.236.36.204/admin/');
define('HTTPS_CATALOG', 'http://104.236.36.204/');
...
define('DB_PASSWORD', 'rothrug');
define('DB_DATABASE', 'rothrug');
