<?php
/**
* Template Name: Traditional Rugs Page 
*/
        	...
        	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
            	<div class="neutral_essential">
                    <a href="<?php the_field('neutral_essentials_link'); ?>">
                        ...
                        <div class="neutral_cntnt neutral_cntnt1">Traditional <br><span>Area Rugs</span><br><p class="tr">View area rugs </p></div>
                    </a>
                </div>
            </div>
            	...
            	<div class="modern_area_rugs">
                    <a href="<?php the_field('modern_area_rugs_link'); ?>">
                        ...
                        <div class="mdrn_ar_rg_tx">
                            <div class="mdrn_ar_rg_tx1 mdrn_ar_rg_tx11">Neutral</div>
                            <div class="mdrn_ar_rg_tx2 mdrn_ar_rg_tx22">Essentials</div>
                            <div class="mdrn_ar_rg_tx3 mdrn_ar_rg_tx31"><p>View neutral color area rugs ></p></div>
                        </div>
                    </a>
                </div>
            </div>
