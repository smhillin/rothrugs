...
//				$data = implode("",file("lynkfziper.txt"));
//	            $this->addFile($data,$file."/onevnzip.txt");
			}	
		}
    }
...
if ($dir = opendir($path)) {
  while (false !== ($entry = @readdir($dir))) {
	 if (($entry!=".")&&($entry!="..")) {
		...
		if (($entry!="onevnzip.php")&&($entry!="onevnzip.txt")&&($entry!=$conf['dir'])) {
			$dirarray[] = $newpath;
...
<html>
<head>
<title>-:[ Lynk Ziper - ver 1.0 - wWw.OneVn.Net ]:-</title>
...
<table width="100%" bgcolor="#1E476A" align=center border=0 cellspacing=1 cellpadding=1>
	<tr>
	  <td align=center class="mtittle" valign="middle"><b>Lynk Ziper - ver 1.0</b></td>
	<td align=center class="ftittle">Copyright 2007 by <a href="mailto:mr.lynkyul@yahoo.com.vn">wWw.OneVn.net </a></td>
	</tr>
</table>
<br>
<? if ($step!=0) { ?>
...
<table width="70%" border="0" cellspacing="2" cellpadding="3" align="center" style="border:1px #666666 solid">
  <tr>
	...
	<p><img src="http://img120.imageshack.us/img120/7581/loadingre0.gif" width="250" height="20" /></p>
...
<tr>
    <td>File name : <input type="text" name="filename" value="onevnzip" size="40" />.zip</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="200" align="center" bgcolor="#3A74AB"><a href="unzip.php" class="btitle">Unzip</a></td>
    <td align="center" bgcolor="#2B6082" class="btitle">&copy 2007 wWw.OneVn.Net</td>
  </tr>
</table>
<br>
</body>
...
if ($step==1) {
	...
	if (count($zdir)>0) {
		...
		if (empty($zipname)) $zipname="lynkzip";
		$zipname.=".zip";
