...
<?php } ?>
 <section id="newsletter" class="bg-blue">
    <div id="mi<?php echo $module_id; ?>" class="container mailchimp-integration box common-cont newsletter_sec">
        <div class="col-md-6 text-center">
            <div class="box-heading">
                <?php if ($settings['moduletext_heading_'.$language]) { ?>
                    <?php if (version_compare(VERSION, '2.0', '>=')) echo '<h2>'; ?>
                ...
                <div class="mi-toptext"><p><?php echo html_entity_decode($settings['moduletext_top_'.$language], ENT_QUOTES, 'UTF-8'); ?></p></div>
                <?php } ?>
            </div>
        </div>
        <div class="col-md-6">
                ...
                <div class="mi-message"></div>
                    ...
                    <?php } else { ?>
                            ...
                            <div class="mi-block">
                                    ...
                                    <input type="text" class="form-control" name="email" onkeydown="if (event.keyCode == 13) miSubscribe<?php echo $module_id; ?>($(this))" <?php if ($email) echo 'value="' . $email . '" disabled="disabled"'; ?> placeholder="Enter Your Email Address"/>
                            </div>
                    ...
                    <?php if (!empty($settings['modules_lists'])) { ?>
                    ...
                    <?php if (!$subscribed) { ?>
                            <div class="mi-block mi-button">
                                    <a class="button btn btn-red" onclick="miSubscribe<?php echo $module_id; ?>($(this))"><?php echo $settings['moduletext_button_'.$language]; ?></a>
                            </div>
                    <?php } elseif ($interest_groups || !empty($lists)) { ?>
                            <div class="mi-block mi-button">
                                    <a class="button btn btn-red" onclick="miSubscribe<?php echo $module_id; ?>($(this))"><?php echo $settings['moduletext_updatebutton_'.$language]; ?></a>
                            </div>
                    <?php } ?>
            </div>
        </div>                                  
