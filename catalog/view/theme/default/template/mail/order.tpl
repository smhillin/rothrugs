...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  <p style="margin-top: 0px; margin-bottom: 10px; font-size: 15px;font-family: inherit;font-weight: bold;">THANK YOU!</p>
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_greeting; ?></p>
  <?php if ($customer_id) { ?>
  <p style="margin-top: 0px; margin-bottom: 10px; font-size: 15px;font-family: inherit;font-weight: bold;">YOUR ORDER</p>
  ...
  <?php } ?>
  <p style="margin-top: 0px; margin-bottom: 10px; font-size: 15px;font-family: inherit;font-weight: bold;">QUESTIONS?</p>
  <p style="margin-top: 0px; margin-bottom: 20px;">Just contact us by replying to this email and we will help you in any way we can!</p>
