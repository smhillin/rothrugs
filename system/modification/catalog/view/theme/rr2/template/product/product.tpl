...
<div class="container product-page">
    <div class="row">
        <div id="content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="description">
                                ...
                                <?php if($attribute_groups){
                                    ...
                                    foreach ($attribute_groups as $attribute_group) {
                                        foreach ($attribute_group['attribute'] as $attributes) { 
                                            echo '<li>'.$attributes['name'].' : '.$attributes['text'].'</li>';
                                        } 
                                    } 
                                    echo '</ul>';
                                } ?>
            ...
            <div class="col-md-6 col-sm-12 quality ">
...
Product Name :- <?php echo $heading_title ; ?>
                ...
                <?php if($discount_flag_text){ ?>
                <div class="custom_discount_text">
                   <?php echo $discount_flag_text ; ?>
                </div>
                <?php } ?>
                                ...
                                <tr class="tr-sizes">
                                    ...
                                    <td>
                                        <div class="quantity" id="<?php echo $o['product_option_id']; ?>" data-product-id="<?php echo $product_id ?>">
                                            <input type="button" name="<?php echo $size['product_option_value_id']; ?>"  data-product-color-id="<?php echo $o['product_option_color_id']['option_id'] ?>" data-product-color-value-id="<?php echo $o['product_option_color_id']['value_id']  ?>" data-price="<?php echo $size['price']; ?>" value="Add to cart" data-val="" placeholder="" size="5">
                                        </div>
                                    </td>
                                </tr>
                                <?php endforeach ?>
                ...
                <?php if (isset($related_products)): ?>
                    <div class="relate-product">
                        ...
                        <ul class="row">
                            ...
                            <li class="col-md-5 col-sm-4 col-xs-6 rug <?php echo $classresponsive;?>">
                                <?php 
                                    $RothRug = strpos($re_product['name'], 'vvvvv');
                                ?>
                                <div class="rug_img">
                                    <a href="<?php echo !empty($RothRug) ? 'rugs/?page_id=208/' : $re_product['href'] ?>" title="<?php echo $re_product['name'] ?>"><img src="<?php echo $re_product['thumb'] ?>" alt="<?php echo $re_product['name'] ?>" title="<?php echo $re_product['name'] ?>" class="img-responsive" /></a>
                                </div>
                                <?php if($re_product['sale_flag'] == 1) { ?>
                                <div class="offer">
                                ...
                                <div class="rug_details">
                                    <div  class="rug_title">
                                        <a href="<?php echo !empty($RothRug) ? 'rugs/?page_id=208/' : $re_product['href'] ?>">
                                            <p><?php echo $re_product['name'] ?></p>
                                        </a>
                                    </div>
                                    <p class="price">Starting at <span><?php echo $priceto ?></span></p>
                                    <div class="view-btn text-center"><a href="<?php echo $re_product['href'] ?>">View Details</a></div>
                                </div>
                            </li>
                            <?php endforeach ?>
                            <?php endif ?>
            ...
            <script>
                if ($(window).width() > 361) {
                    $(".zoom").elevateZoom({zoomWindowWidth: 300, zoomWindowHeight: 300, scrollZoom: false, containLensZoom: true, gallery: 'thumbs', cursor: 'pointer', galleryActiveClass: "active"})
