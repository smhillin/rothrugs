...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_landing_page'] = $this->language->get('entry_landing_page');
		...
		$data['tab_combination'] = $this->language->get('tab_combination');
		...
		if (isset($this->request->get['category_id'])) {
			$data['combinations'] = $this->model_catalog_category->getCombinations($this->request->get['category_id']);
		}else {
