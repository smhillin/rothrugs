      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-combination" data-toggle="tab"><?php echo $tab_combination; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-combination">
              <div class="comb">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-parent"><?php echo $entry_landing_page; ?></label>
                <div class="col-sm-9">
                  <input type="text" name="landing_page" value="<?php echo $category_description[1]['landing_page']; ?>" placeholder="<?php echo $entry_landing_page; ?>" class="form-control" />
                </div>
              </div>
              <?php
                ...
                $ii=1;
                  foreach($combinations as $val){
                    ?>
                    <div class="form-group">
                      <label class="col-sm-2 control-label"><?php ($ii==1) ? print $entry_combination : print ''; ?></label>
                      <div class="col-sm-9">
                        <input type="text" name="combination[]" value="<?php echo $val; ?>" placeholder="<?php echo $entry_combination; ?>" class="form-control" />
                      </div>
                      <?php if($ii !== 1) {?> 
                      <div class="col-sm-1">        <button type="button" class="btn btn-default btn-sm del_btn"><span class="glyphicon glyphicon-trash"></span></button></div>
                      <?php } ?>
                    </div>  
                    <?php
                    $ii++;
                ...
                ?>
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_combination; ?></label>
                <div class="col-sm-9">
                  <input type="text" name="combination[]" value="" placeholder="<?php echo $entry_combination; ?>" class="form-control" />
                </div>
              </div>                
                <?php 
                }
              ...
              <div class="form-group">
                <label class="col-sm-2" for="input-parent"></label>
                <div class="col-sm-9">
                  <button class="add_more_comb pull-right">Add more</button>
                </div>
              </div>
            </div>
          </div>
...
$(".add_more_comb").click(function(e) {
  e.preventDefault();
  var cmb_html = '<div class="form-group"><label class="col-sm-2 control-label"></label><div class="col-sm-9"><input type="text" name="combination[]" class="form-control" placeholder="<?php echo $entry_combination ?>"/></div><div class="col-sm-1">        <button type="button" class="btn btn-default btn-sm del_btn"><span class="glyphicon glyphicon-trash"></span></button></div></div>';
    $(".comb").append(cmb_html);
});
