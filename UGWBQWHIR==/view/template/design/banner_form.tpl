            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <td class="text-left" style="width: 30%;">
                    <textarea name="banner_image[<?php echo $image_row; ?>][link]" class="form-control"><?php echo $banner_image['link']; ?></textarea>
...
function addImage() {
	...
	//html += '  <td class="text-left"><input type="text" name="banner_image[' + image_row + '][link]" value="" placeholder="<?php echo $entry_link; ?>" class="form-control" /></td>';	
        html += '  <td class="text-left"><textarea name="banner_image[' + image_row + '][link]" class="form-control"></textarea></td>';	
