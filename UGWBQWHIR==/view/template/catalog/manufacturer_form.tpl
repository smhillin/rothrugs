      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-manufacturer" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sale-flag"><?php echo $entry_sale_flag; ?></label>
            <div class="col-sm-10">
                <select name="sale_flag" class="form-control">
                    <option value="0" <?php if($sale_flag==0) { echo 'selected'; } ?>>No</option>
                    <option value="1" <?php if($sale_flag==1) { echo 'selected'; } ?>>Yes</option>
                </select>
            </div>
          </div>
        </form>
