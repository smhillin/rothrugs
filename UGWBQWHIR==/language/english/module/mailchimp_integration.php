...
$_['entry_testing_mode']				= 'Testing Mode: <div class="help-text">Enabling this log errors and webhook calls to the System > Error Log.</div>';
...
$_['entry_manual_sync']					= 'Manually Sync OpenCart & MailChimp: <div class="help-text">You should only need to manually sync once, when you first install this extension. After that, all syncing should happen automatically in the background.<br /><br />If an e-mail exists in both OpenCart and MailChimp, the information associated with it in OpenCart will be used for the sync. Confirmation e-mails are NOT sent when manually syncing, so be sure to have approval from your customers to add them to your mailing list.</div>';
$_['button_sync']						= 'Sync';
