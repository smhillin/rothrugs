...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_sort_order'] = $this->language->get('entry_sort_order');
                $data['entry_sale_flag'] = $this->language->get('entry_sale_flag');
		...
		if (isset($this->request->post['sort_order'])) {
			...
			$data['sort_order'] = '';
                ...
                if (isset($this->request->post['sale_flag'])) {
			$data['sale_flag'] = $this->request->post['sale_flag'];
		} elseif (!empty($manufacturer_info)) {
			$data['sale_flag'] = $manufacturer_info['sale_flag'];
		} else {
			$data['sale_flag'] = '';
		}
