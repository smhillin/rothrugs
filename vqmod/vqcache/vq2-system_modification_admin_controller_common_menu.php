...
$data['text_seo'] = $this->language->get('text_seo');
				...
				$data['text_seo_setting'] = $this->language->get('text_seo_setting');
...
$data['customize'] = $this->url->link('catalog/seo/customize','token=' . $this->session->data['token']);
				...
				$data['seo_setting'] = $this->url->link('catalog/setting','token=' . $this->session->data['token'],'SSL');
